...
| Battle tools | `astrbot_plugin_auto_trpg_dm/tools/spatial_tools.py` still exposes `get_battle_snapshot()` with raw battle/grid output; `tools/registry.py` exposes it in several tactical toolsets. |
